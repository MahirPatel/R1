...
<head>
	<meta charset="UTF-8">
	<title>4Square JAVA language</title>
...
<div class="page-wrapper">
	...
	<section class="banner" style="background-image: url(images/header-bg.jpg);">
		<div class="container">
			<h2>Why we need to learn Object oriented JAVA Programming Language ???</h2>
	...
	<section class="main-demo" id="main-demo">
		...
		<div class="sec-title centered">
					<h2>Object Oriented JAVA Programming Language</h2>
					<div class="text">Type introduction here...</div>
				    </div>
			<div class="text-center">
					<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/grEKMHGYyns" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/grEKMHGYyns" target="_blank">JAVA Language Video 1</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/grEKMHGYyns" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/grEKMHGYyns" target="_blank">JAVA Language Video 2</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/grEKMHGYyns" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/grEKMHGYyns" target="_blank">JAVA Language Video 3</a></h3>
				</div>
			</div>
			<div class="text-center">
					<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/grEKMHGYyns" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/grEKMHGYyns" target="_blank">JAVA Language Video 4</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/grEKMHGYyns" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/grEKMHGYyns" target="_blank">JAVA Language Video 5</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/grEKMHGYyns" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/grEKMHGYyns" target="_blank">JAVA Language Video 6</a></h3>
				</div>
			</div>
		</div>
	</section>
