...
<div class="page-wrapper">
	...
	<section class="banner" style="background-image: url(images/header-bg.jpg);">
		<div class="container">
			<h2>Why we need to learn Object oriented C++ Programming Language ???</h2>
	...
	<section class="main-demo" id="main-demo">
		...
		<div class="sec-title centered">
					<h2>Object Oriented C++ Programming Language</h2>
					<div class="text">Type introduction here...</div>
				    </div>
			<div class="text-center">
					<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/mUQZ1qmKlLY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/mUQZ1qmKlLY" target="_blank">C++ Language Video 1</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/mUQZ1qmKlLY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/mUQZ1qmKlLY" target="_blank">C++ Language Video 2</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/mUQZ1qmKlLY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/mUQZ1qmKlLY" target="_blank">C++ Language Video 3</a></h3>
				</div>
			</div>
			<div class="text-center">
					<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/mUQZ1qmKlLY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/mUQZ1qmKlLY" target="_blank">C++ Language Video 4</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/mUQZ1qmKlLY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/mUQZ1qmKlLY" target="_blank">C++ Language Video 5</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<iframe src="https://www.youtube.com/embed/mUQZ1qmKlLY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
					<h3><a href="https://www.youtube.com/embed/mUQZ1qmKlLY" target="_blank">C++ Language Video 6</a></h3>
				</div>
			</div>
		</div>
	</section>
