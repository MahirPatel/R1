...
<div class="page-wrapper">
	...
	<section class="banner" style="background-image: url(images/header-bg.jpg);">
		<div class="container">
			<h2>What Is Language Learing Program ???</h2>
		...
		<div class="container">
			<div class="text-center">
				<div class="sec-title centered">
					<h2>Language Learing Program</h2>
					<div class="text">Language Learing Program in we learn the basic core languages of computer science department.we learn language like c programming , object oriented C++ programming and object oriented Java programming with some videos , slides and pdf which may helps in further implementation.</div>
				    </div>
					<div class="col-lg-4 col-md-6">
					<div class="image tran-5" style="background-image:url(images/demo-4.jpg);">
						<a href="llpc.php" target="_blank"><img src="images/page-shape.jpg" alt=""></a>
					</div>
					<h3><a href="llpc.php" target="_blank">Language Learing C Programming</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="image tran-3" style="background-image:url(images/demo-5.jpg);">
						<a href="llpcc.php" target="_blank"><img src="images/page-shape.jpg" alt=""></a>
					</div>
					<h3><a href="llpcc.php" target="_blank">Language Learing C++ Programming</a></h3>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="image tran-3" style="background-image:url(images/demo-6.jpg);">
						<a href="llpj.php" target="_blank"><img src="images/page-shape.jpg" alt=""></a>
					</div>
					<h3><a href="llpj.php" target="_blank">Language Learing JAVA Programming</a></h3>
				</div>
			</div>
		</div>
	</section>
